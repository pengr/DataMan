...
export NLTK_DATA=xxxxxxx/nltk_data

FILES=("train_chunk1_half1" 
...
for FILE in "${FILES[@]}"; do
    python $CODE_DIR/examples/fineweb_slimpajama.py \
    --input $DATA_DIR/SlimPajama-627B/qurating_tokenized_chunk/analyse/${FILE}_annotated_success \
    --output $DATA_DIR/SlimPajama-627B/fineweb_slimpajama/${FILE}
done