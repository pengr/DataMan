...
dataset=${DATASET:-"$DATA_DIR/DataMan/ChineseWebText2.0/data_filtering/moe/grammatical_diversity/train_filtered/0 $DATA_DIR/DataMan/ChineseWebText2.0/data_filtering/moe/grammatical_diversity/train_filtered/1 $DATA_DIR/DataMan/ChineseWebText2.0/data_filtering/moe/grammatical_diversity/train_filtered/2 $DATA_DIR/DataMan/ChineseWebText2.0/data_filtering/moe/grammatical_diversity/train_filtered/3 $DATA_DIR/DataMan/ChineseWebText2.0/data_filtering/moe/grammatical_diversity/train_filtered/4 $DATA_DIR/DataMan/ChineseWebText2.0/data_filtering/moe/grammatical_diversity/train_filtered/5 $DATA_DIR/DataMan/ChineseWebText2.0/data_filtering/moe/grammatical_diversity/train_filtered/6 $DATA_DIR/DataMan/ChineseWebText2.0/data_filtering/moe/grammatical_diversity/train_filtered/7 $DATA_DIR/DataMan/ChineseWebText2.0/data_filtering/moe/grammatical_diversity/train_filtered/8 $DATA_DIR/DataMan/ChineseWebText2.0/data_filtering/moe/grammatical_diversity/train_filtered/9"}
# suffix to append to run name
suffix=${SUFFIX:-"grammatical_diversity-top_k-sampling"}
