...
base_arguments=(
    ...
    --do_train                           # 设置进行训练过程
    --model_name_or_path "$CKPT_DIR/DataMan/pretrain/en/lm-Sheared-LLaMA-1.3B-select_30B_tokens_by-uniform-sample_with_overall_score5.0/checkpoint-merge"  # <修改代码>，设置模型路径
