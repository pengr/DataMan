...
dataset=${DATASET:-"$DATA_DIR/DataMan/Slimpajama-627B/data_filtering/finance/train_filtered/0"}
# suffix to append to run name
suffix=${SUFFIX:-"uniform-sample_with_overall_score5.0_finance_cpt"}
