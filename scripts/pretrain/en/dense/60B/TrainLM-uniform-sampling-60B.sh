...
for chunk in {0..17}; do
    input_files+="$DATA_DIR/DataMan/Slimpajama-627B/data_filtering/uniform/train_filtered_60B/${chunk} "
done
...
base_arguments=(
    ...
    # --resume_from_checkpoint "$CKPT_DIR/princeton-nlp/lm-1.3B-select_60B_tokens_by-uniform-sampling"
