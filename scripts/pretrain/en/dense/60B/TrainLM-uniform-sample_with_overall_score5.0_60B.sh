...
for chunk in {0..17}; do
    input_files+="$DATA_DIR/DataMan/Slimpajama-627B/data_filtering/overall_score5/train_filtered_60B/${chunk} "
done
...
run_name="lm-$(basename $arch)-select_60B_tokens_by-${suffix}"
...
base_arguments=(
    ...
    # --resume_from_checkpoint "$CKPT_DIR/DataMan/pretrain/en/lm-Sheared-LLaMA-1.3B-select_60B_tokens_by-uniform-sample_with_overall_score5.0"
