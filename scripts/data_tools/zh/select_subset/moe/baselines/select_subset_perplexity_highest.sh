...
for chunk in {1..151}; do
    ...
    input_files+="$DATA_DIR/DataMan/ChineseWebText2.0/ppl/${formatted_chunk}_ppl "
done
...
--inputs $input_files \
--output $DATA_DIR/DataMan/ChineseWebText2.0/data_filtering/moe/perplexity_highest/train_filtered \
--metric_field ppl \
