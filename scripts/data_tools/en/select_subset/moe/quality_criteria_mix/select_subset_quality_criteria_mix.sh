...
--inputs $input_files \
--output $DATA_DIR/DataMan/Slimpajama-627B/data_filtering/moe/quality_criteria_mix/train_filtered \
--metric_field accuracy coherence creativity grammatical_diversity knowledge_novelty language_consistency originality professionalism semantic_density sensitivity structural_standardization style_consistency topic_focus overall_score \
--seq_len_field length \
--domain_field source_domain application_domain \
