...
--inputs $input_files \
--output $DATA_DIR/DataMan/Slimpajama-627B/data_filtering/structural_standardization/train_filtered \
--metric_field structural_standardization \
--seq_len_field length \
--domain_field source_domain application_domain \
--tokens 30_000_000_000 \
--tokens_per_shard 31_000_000_000 \
--margin 0.1 \
--seed 42 \
--num_workers 128 \
