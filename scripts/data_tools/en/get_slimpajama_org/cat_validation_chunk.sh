...
# cascading chunks 1-5 of slimpajama's validation set
OUTPUT_FILE="${DATA_DIR}/DataMan/Slimpajama-627B/org/validation.jsonl"
for CHUNK in $(seq 1 5); do
    start=$(date +%s) 
    CHUNK_DIR="${DATA_DIR}/SlimPajama-627B/validation/chunk${CHUNK}"
