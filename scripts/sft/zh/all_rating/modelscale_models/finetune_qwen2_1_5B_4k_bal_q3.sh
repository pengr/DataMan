...
EVAL_DATA="$DATA_DIR/DataMan/Qwen-sft/Qwen2-zh/finetune_valid.jsonl"
OUTPUT_DIR="$CKPT_DIR/DataMan/sft/zh/analyse/modelscale_models/Qwen2-1_5B-4k_bal_q3-zh/"
...
torchrun $DISTRIBUTED_ARGS $CODE_DIR/sft/finetune_qwen2.py \
    ...
    --logging_steps 1 \
    --report_to "wandb" \
    --run_name "Qwen2-1_5B-4k_bal_q3-zh" \
